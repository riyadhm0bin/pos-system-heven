        ...
        <div class="row login-box">
            <div class="col-lg-6 form-section">
                <div class="form-inner">
                  ...
                  <h3>নতুন পাসওয়ার্ড তৈরি করুন</h3>
     ...
     <div class="text-success tex-center"><?php echo $this->session->flashdata('success'); ?></div>
      ...
      <input type="hidden" name="otp" id="otp" value="<?= $otp;?>">
                        ...
                        <div class="form-group position-relative clearfix">
                            <input name="password" type="password" class="form-control" placeholder="এখানে নতুন পাসওয়ার্ড লিখুন" id="password">
                        </div>
                                                <div class="form-group position-relative clearfix">
                            <input name="cpassword" type="password" class="form-control" placeholder="এখানে নতুন পাসওয়ার্ড কনফার্ম করুন" id="cpassword">
                        </div>
                        <div class="form-group mb-0 clearfix">
                            <button type="submit" class="btn btn-lg btn-primary btn-theme">পাসওয়ার্ড পরিবর্তন করুন</button>
                        </div>
